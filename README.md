...
---
## Overview
This repository implements AURORA 2.0 adaptive mining monitoring pipeline, an unsupervised, mine-specific system for the purpose of detecting and monitoring excavationtion activity using Sentinel-2 time-series imagery.
...
---
## Method Summary
- Filteration of Sentinel-2 images by mine boundaries and cloud-masked using SCL
